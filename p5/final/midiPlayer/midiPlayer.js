...
class MidiPlayer {
    ...
    setPianoRoll(pianoRoll, tsCallback) {
        ...
        this.repeatId = Tone.Transport.scheduleRepeat(function(time) {
    ...
    clear() {
        Tone.Transport.stop();
        if (this.repeatId) Tone.Transport.clear(this.repeatId);
        //if (this.repeatId) Tone.clear(this.repeatId);
